-- Clean migration for Hoodly app - Supabase-only architecture
...
-- Step 6: Create DM threads table
...
-- Step 7: Create DM messages table
...
-- Step 10: Create reactions table
...
-- Step 12: Create device_tokens table
...
-- Step 16: Set REPLICA IDENTITY FULL for real-time tables
...
-- Step 19: Create RLS Policies for rooms
...
-- Step 20: Create RLS Policies for memberships
...
-- Step 21: Create RLS Policies for messages
...
-- Step 22: Create RLS Policies for DM threads
...
-- Step 23: Create RLS Policies for DM messages
...
-- Step 24: Create RLS Policies for posts
...
-- Step 25: Create RLS Policies for comments
...
-- Step 26: Create RLS Policies for reactions
...
-- Step 27: Create RLS Policies for notifications
...
-- Step 30: Create RLS Policies for events
...
-- Step 31: Create nearby_rooms function
...
-- Step 32: Create trigger function for room creation
...
-- Step 33: Create trigger for room creation
CREATE TRIGGER room_creation_trigger
    AFTER INSERT ON public.rooms
    FOR EACH ROW
    EXECUTE FUNCTION public.handle_room_creation();

-- Step 34: Create trigger function for new users
...
-- Step 35: Create trigger for new users
