-- Smart Migration: Adapt to Existing Hoodly Database Structure (FIXED)
...
-- Step 17: Create RLS Policies for private_messages (FIXED - uses sender_id/receiver_id)
...
CREATE POLICY "Users can view messages in their DM threads" ON public.private_messages FOR SELECT USING (
