-- 🔧 FINAL COMPREHENSIVE ERROR FIXES (CORRECTED)
-- Fix all current database errors with correct column names from actual schema
...
-- ===========================================
-- 4. FIX MESSAGES RLS POLICIES (CORRECTED)
-- ===========================================
...
-- Create simplified message policies (using sender_id, not user_id)
...
-- Create private message policies
...
-- Create friend request policies
...
BEGIN
  ...
  RAISE NOTICE '✅ Messages RLS policies fixed (using sender_id)';
  RAISE NOTICE '✅ Private messages RLS policies added';
